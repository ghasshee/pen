...
val pr_layout_info : layout_info -> unit
...
val realize_pseudo_opcode :
  post_layout_info -> Assoc.contract_id -> PseudoImm.pseudo_imm Evm.opcode -> Big_int.big_int Evm.opcode
