...
# 195 "parser.ml"
                ...
                let _v : 'tv_msg_info = 
# 156 "parser.mly"
                                            ( {Syntax.msg_value_info=_1; msg_reentrance_info=_2} )
# 210 "parser.ml"
                 in
                let (_menhir_env : _menhir_env) = _menhir_env in
...
# 230 "parser.ml"
                    ...
                    let ((_5 : 'tv_msg_info) : 'tv_msg_info) = _v in
...
# 147 "parser.mly"
                                              ( Syntax.SendExpr{Syntax.send_head_cntrct=_1; send_head_method=Some _3; send_args=_4; send_msg_info=_5},() )
# 268 "parser.ml"
                     in
                ...
                | MenhirState122 ->
                    ...
                    let (_ : _menhir_state) = _menhir_s in
                    let ((_6 : 'tv_msg_info) : 'tv_msg_info) = _v in
                    ((let (_menhir_stack, _menhir_s, (_1 : 'tv_expr)) = _menhir_stack in
                    let _v : 'tv_expr = 
# 146 "parser.mly"
                                             ( Syntax.SendExpr{Syntax.send_head_cntrct=_1; send_head_method=None; send_args=[]; send_msg_info=_6},() )
# 284 "parser.ml"
                     in
...
# 300 "parser.ml"
                    ...
                    let (_ : _menhir_state) = _menhir_s in
                    let ((_4 : 'tv_msg_info) : 'tv_msg_info) = _v in
...
# 145 "parser.mly"
                                             ( Syntax.NewExpr{Syntax.new_head=_2; new_args=_3; new_msg_info=_4},() )
# 338 "parser.ml"
                     in
...
# 144 "parser.mly"
                                             ( Syntax.FunCallExpr {Syntax.call_head=_1; call_args=_2 }, () )
# 731 "parser.ml"
             in
...
and _menhir_reduce33 : _menhir_env -> 'ttv_tail * _menhir_state * 'tv_lexpr -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let (_menhir_stack, _menhir_s, (l : 'tv_lexpr)) = _menhir_stack in
    let _v : 'tv_expr = 
# 151 "parser.mly"
                                             ( Syntax.ArrayAccessExpr l, () )
# 1526 "parser.ml"
     in
...
# 2316 "parser.ml"
    ...
    | MenhirState89 ->
        ...
        | RSQBR ->
            ...
            let _v : 'tv_lexpr = 
# 166 "parser.mly"
                                              ( Syntax.ArrayAccessLExpr{Syntax.array_access_array=_1; array_access_index=_3} )
# 2362 "parser.ml"
             in
            let (_menhir_env : _menhir_env) = _menhir_env in
...
# 2579 "parser.ml"
    ...
    | MenhirState106 ->
        ...
        | COMMA | LAND | REENTRANCE | RPAR | RSQBR | SEMI | THEN ->
            ...
            ((let ((_menhir_stack, _menhir_s, (lhs : 'tv_expr)), _, (rhs : 'tv_expr)) = _menhir_stack in
            let _v : 'tv_expr = 
# 132 "parser.mly"
                                              ( Syntax.LandExpr (lhs, rhs), () )
# 2620 "parser.ml"
             in
...
# 3004 "parser.ml"
    ...
    | MenhirState142 ->
        ...
        | SEMI ->
            ...
            let _v : 'tv_stmt = 
# 111 "parser.mly"
                                              ( Syntax.ReturnStmt{Syntax.ret_expr=_2; ret_cont=_5} )
# 3050 "parser.ml"
             in
...
# 3238 "parser.ml"
            ...
            ((let (((_menhir_stack, _menhir_s, (_1 : 'tv_typ)), (_2 : (
# 8 "parser.mly"
       (string)
# 3243 "parser.ml"
            ...
            let _v : 'tv_stmt = 
# 113 "parser.mly"
                                             ( Syntax.VarDeclStmt{ Syntax.var_declare_type=_1; var_declare_name=_2; var_declare_value=_4 } )
# 3248 "parser.ml"
             in
...
# 4190 "parser.ml"
    ...
    | MenhirState3 | MenhirState21 ->
        ...
        let _v : 'tv_event_arg = 
# 87 "parser.mly"
                                    ( Syntax.event_arg_of_arg _1 false )
# 4207 "parser.ml"
         in
...
# 80 "parser.mly"
                                            ( Syntax.Method { mthd_ret_ty = []; Syntax.mthd_name = _4; mthd_args = _5 } )
# 4409 "parser.ml"
                 in
...
# 4466 "parser.ml"
                ...
                ((let ((((_menhir_stack, _menhir_s), _, (_3 : 'tv_typ)), (_4 : (
# 8 "parser.mly"
       (string)
# 4471 "parser.ml"
                ))), _, (xs : 'tv_loption_separated_nonempty_list_COMMA_arg__)) = _menhir_stack in
...
# 79 "parser.mly"
                                            ( Syntax.Method { mthd_ret_ty = [_3]; Syntax.mthd_name = _4; mthd_args = _5 } )
# 4495 "parser.ml"
                 in
...
# 8 "parser.mly"
       (string)
# 4924 "parser.ml"
            ))), _, (xs : 'tv_loption_separated_nonempty_list_COMMA_event_arg__)) = _menhir_stack in
            let _v : 'tv_cntrct = let _3 =
              let xs =
                let x = 
# 232 "<standard.mly>"
