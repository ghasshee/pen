...
and expr_become  e                  =   match fst e with
    | TmAbort | TmUnit | EpTrue | EpFalse | EpNow | EpThis | EpValue | EpSender | TmId _  | EpUint8 _ | EpUint256 _ -> []
    | EpParen e | EpAddr e | EpNot e | EpDeref e | EpBalance e | TmSlfDstrct e ->  expr_become e
