----------------------------------------------------------------
--  ghasshee : ghasshee@gmail.com
--
--  2023 / 06
--  Mat.hs is a generalization of matrix library on Hackage
--  we added "mult" function.  
--  Matrix behaves over "semiring" rather than ordinal "ring" 
--
----------------------------------------------------------------
